...
![](D:\java笔记\Java脑图\在链表的开头插入一个新结点.png)
...
![](D:\java笔记\Java脑图\在链表的结尾插入一个新结点.png)
...
![](D:\java笔记\Java脑图\stack的开发用例轨迹.png)
